    ...
    <div className="forecast-item">
      <div className="forecast-info-left">
        ...
        <div className="forecast-item-info">
          <div className="forecast-item-date">{getDateString(modifiedDate.getDate(), modifiedDate.getDay(), modifiedDate.getMonth())}</div>
          <div className="forecast-item-condition">{condition.text}</div>
        </div>
      </div>
      <div className="forecast-info-right">
        <Temperature temp_c={avgtemp_c} fontSize={24} />
      </div>
    </div>
  );
}
